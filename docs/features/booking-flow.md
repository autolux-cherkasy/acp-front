...
- `src/features/add-order` — Логіка додавання рейсу в кошик (`AddOrderButton`).
- `src/entities/ticket` — Модель квитка (типи, статус) та базовий UI (`TicketStatusBadge`), яка використовується на етапі оплати/особистого кабінету.
